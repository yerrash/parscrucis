...
export class AbilitySchema extends foundry.abstract.DataModel {
  static defineSchema() {
    return {
      ...
      subtype: new field.StringField({ initial: "power" }),
      subSubtype: new field.StringField({ initial: "" }),
      group: new field.StringField({ initial: "" }),
      groupLabel: new field.StringField({ initial: "" }),
      subgroup: new field.StringField({ initial: "" }),
      subgroupLabel: new field.StringField({ initial: "" }),
